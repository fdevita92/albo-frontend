...
const exporter = data => {
  const newData = data.map((record,i) => ({
    ...
    email: (Object.hasOwn(record,'email') && record.email != null) ? record.email.toString() : " ",
    ...
    invitedDate: (Object.hasOwn(record,'invitedDate') && record.invitedDate != null) ? record.invitedDate.toString() : " ",
    //winnerDate: record.hasOwnProperty('winnerDate') ? record.winnerDate.toString() : " ",
    winnerDate: (Object.hasOwn(record,'winnerDate') && record.winnerDate != null) ? record.winnerDate.toString() : " ",
  }));
