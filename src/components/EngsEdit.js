...
import { Edit, SimpleForm, TextInput, DateInput, AutocompleteArrayInput} from 'react-admin';
...
const EngsEdit = (props) => {
    return (
      <Edit title="Modifica Professionista" {...props}>
        <SimpleForm>
