  ...
  return (
    <Create title="Aggiungi nuova Impresa" {...props}>
      <SimpleForm>
        ...
        <SelectArrayInput source="categories_soa" label="Categoria SOA" choices={categories} />
        <SelectArrayInput source="categories_not_soa" label="Categoria non SOA" choices={categories} />
